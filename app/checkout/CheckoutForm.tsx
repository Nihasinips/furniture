...
import {PaymentElement, useElements, useStripe , AddressElement, ShippingAddressElement} from "@stripe/react-stripe-js"
...
const CheckoutForm: React.FC<CheckoutFormProps>= ({clientSecret,handleSetPaymentSuccess}) => {
    ...
    const formattedPrice = formatPrice(cartTotalAmount+500+500)
